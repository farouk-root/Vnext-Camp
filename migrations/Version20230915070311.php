 ...
 */
final class Version20230915070311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE volunteer (id INT AUTO_INCREMENT NOT NULL, associations_id INT DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, nationality VARCHAR(255) NOT NULL, age INT DEFAULT NULL, occupation VARCHAR(255) DEFAULT NULL, INDEX IDX_5140DEDB4122538A (associations_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE volunteer ADD CONSTRAINT FK_5140DEDB4122538A FOREIGN KEY (associations_id) REFERENCES association (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE volunteer DROP FOREIGN KEY FK_5140DEDB4122538A');
